  ...
  <div class="app-container">
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <el-button
            v-permission="['GET /admin/brokerage/approve']"
            ...
            >审批</el-button
          >
          <el-button v-permission="['GET /admin/brokerage/approve']" v-else type="info" size="mini"
            >已审批</el-button
          >
        </template>
      </el-table-column>
